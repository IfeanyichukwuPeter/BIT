...
- **[📁 Project Structure](docs/STRUCTURE.md)** - Understand the codebase organization
...
- 🏠 Dynamic landing page with ministry information
- 👥 Leadership team showcase
- 📅 Events management (past, ongoing, upcoming)
